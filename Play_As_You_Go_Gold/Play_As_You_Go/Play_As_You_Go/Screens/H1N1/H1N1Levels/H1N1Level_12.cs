...
namespace Play_As_You_Go
{
    ...
    class H1N1Level_12 : GameScreen
    {
        ...
        public override void Initialize()
        {
            ...
            block1.Position = new Vector2(620, 500);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
            ...
            if (hud.Score >= highScore)
            {
                ...
                effectBackground.Stop();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new H1N1Level_13());
            }
            ...
            else if (block1.Position.X >= 1120)
            {
                block1.Velocity = new Vector2(-3, 0);
            }
