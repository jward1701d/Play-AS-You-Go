    ...
    class H1N1Level_20 : GameScreen
    {
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                pigRow1[a] = row1Pig;
                row1Pig.Position = new Vector2(390 + row1Space,250);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(390 + row2Space, 314);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(390 + row3Space, 378);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(390 + row4Space,442);
            ...
            for (int d = 0; d < pigRow5.Length; d++)
            {
                ...
                pigRow5[d] = row5Pig;
                row5Pig.Position = new Vector2(120 + row5Space, 250);
            ...
            for (int d = 0; d < pigRow6.Length; d++)
            {
                ...
                pigRow6[d] = row6Pig;
                row6Pig.Position = new Vector2(120 + row6Space, 314);
            ...
            block1.Position = new Vector2(562, 200);
            ...
            block2.Position = new Vector2(713, 200);
            ...
            block3.Position = new Vector2(500, 475);
            ...
            block4.Position = new Vector2(775, 475);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
            ...
            foreach (var row1Pigs in pigRow1)
            {
                ...
                if (row1Pigs.Position.Y <= 250)
                {
                    row1Pigs.Velocity = new Vector2(0, 2);
                }
                else if (row1Pigs.Position.Y >= 442)
                {
                    row1Pigs.Velocity = new Vector2(0, -2);
                }
            }
            ...
            foreach (var row2Pigs in pigRow2)
            {
                ...
                if (row2Pigs.Position.Y <= 250)
                {
                    row2Pigs.Velocity = new Vector2(0, 2);
                }
                else if (row2Pigs.Position.Y >= 442)
                {
                    row2Pigs.Velocity = new Vector2(0, -2);
                }
            }
            ...
            foreach (var row3Pigs in pigRow3)
            {
                ...
                if (row3Pigs.Position.Y <= 250)
                {
                    row3Pigs.Velocity = new Vector2(0, 2);
                }
                else if (row3Pigs.Position.Y >= 442)
                {
                    row3Pigs.Velocity = new Vector2(0, -2);
                }
            ...
            foreach (var row4Pigs in pigRow4)
            {
                ...
                if (row4Pigs.Position.Y <= 250)
                {
                    row4Pigs.Velocity = new Vector2(0, 2);
                }
                else if (row4Pigs.Position.Y >= 442)
                {
                    row4Pigs.Velocity = new Vector2(0, -2);
                }
            }
            ...
            foreach (var row5Pigs in pigRow5)
            {
                ...
                if (row5Pigs.Position.Y <= 250)
                {
                    row5Pigs.Velocity = new Vector2(0, 2);
                }
                else if (row5Pigs.Position.Y >= 442)
                {
                    row5Pigs.Velocity = new Vector2(0, -2);
                }
            }
            ...
            foreach (var row6Pigs in pigRow6)
            {
                ...
                if (row6Pigs.Position.Y <= 250)
                {
                    row6Pigs.Velocity = new Vector2(0, 2);
                }
                else if (row6Pigs.Position.Y >= 442)
                {
                    row6Pigs.Velocity = new Vector2(0, -2);
                }
            }
            ...
            foreach (var row7Pigs in pigRow7)
            {
                ...
                if (row7Pigs.Position.Y <= 250)
                {
                    row7Pigs.Velocity = new Vector2(0, 2);
                }
                else if (row7Pigs.Position.Y >= 442)
                {
                    row7Pigs.Velocity = new Vector2(0, -2);
                }
            }
            ...
            foreach (var row8Pigs in pigRow8)
            {
                ...
                if (row8Pigs.Position.Y <= 250)
                {
                    row8Pigs.Velocity = new Vector2(0, 2);
                }
                else if (row8Pigs.Position.Y >= 442)
                {
                    row8Pigs.Velocity = new Vector2(0, -2);
                }
            }
            ...
            if (block2.Position.X >= 1105)
            {
                block2.Velocity = new Vector2(-2, 0);
            }
            else if (block2.Position.X <= 713)
            {
                block2.Velocity = new Vector2(2, 0);
            }
            ...
            if (block5.Position.Y <= 240)
            {
                block5.Velocity = new Vector2(0, 2);
            }
            else if (block5.Position.Y >= 475)
            {
                block5.Velocity = new Vector2(0, -2);
            }

            block6.Update(gameTime);
            if (block6.Position.Y <= 240)
            {
                block6.Velocity = new Vector2(0, 2);
            }
            
            else if (block6.Position.Y >= 475)
            {
                block6.Velocity = new Vector2(0, -2);
            }
