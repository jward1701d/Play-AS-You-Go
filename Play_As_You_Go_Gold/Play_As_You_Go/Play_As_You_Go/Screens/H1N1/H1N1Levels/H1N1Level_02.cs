    ...
    class H1N1Level_02 : GameScreen
    {
        ...
        public override void Initialize()
        {
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(285 + row2Space, 226);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(221 + row3Space, 290);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(829 + row4Space, 226);
            ...
            for (int e = 0; e < pigRow5.Length; e++)
            {
                ...
                pigRow5[e] = row5Pig;
                row5Pig.Position = new Vector2(765 + row5Space, 290);
            ...
            for (int f = 0; f < pigRow6.Length; f++)
            {
                ...
                pigRow6[f] = row6Pig;
                row6Pig.Position = new Vector2(189 + row6Space, 354);
            ...
            for (int f = 0; f < pigRow7.Length; f++)
            {
                ...
                pigRow7[f] = row7Pig;
                row7Pig.Position = new Vector2(733 + row7Space, 354);
            ...
            block.Position = new Vector2(621, 290);
            ...
            for (int a = 0; a < rowblocks.Length; a++)
            {
                ...
                Blockrow.Position = new Vector2(348 + BlockrowSpace, 482);
            ...
            extraLife.Position = new Vector2(615, 225);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
            ...
            if (hud.Score >= highScore)
            {
                ...
                effectBackground.Stop();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new H1N1Level_03());
            }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            #region Draw hud and life bar and FPSCounter
