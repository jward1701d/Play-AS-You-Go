    ...
    class H1N1Level_14 : GameScreen
    {
        ...
        public override void Initialize()
        {
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(605 + row4Space, 440);
            ...
            for (int a = 0; a < pigRow5.Length; a++)
            {
                ...
                pigRow5[a] = row5Pig;
                row5Pig.Position = new Vector2(509 + row5Space, 504);
            ...
            for (int a = 0; a < pigRow6.Length; a++)
            {
                ...
                pigRow6[a] = row6Pig;
                row6Pig.Position = new Vector2(150 + row6Space, 214);
            ...
            for (int a = 0; a < pigRow7.Length; a++)
            {
                ...
                pigRow7[a] = row7Pig;
                row7Pig.Position = new Vector2(150 + row7Space, 278);
            ...
            for (int a = 0; a < pigRow8.Length; a++)
            {
                ...
                pigRow8[a] = row8pig;
                row8pig.Position = new Vector2(1054 + row8Space, 278);
            ...
            for (int a = 0; a < pigRow9.Length; a++)
            {
                ...
                pigRow9[a] = row9pig;
                row9pig.Position = new Vector2(150 + row9Space, 342);
            ...
            for (int a = 0; a < pigRow10.Length; a++)
            {
                ...
                pigRow10[a] = row10pig;
                row10pig.Position = new Vector2(926 + row10Space, 342);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
            ...
            if (hud.Score >= highScore)
            {
                ...
                effectBackground.Stop();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new H1N1Level_15());
