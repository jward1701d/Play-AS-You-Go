    ...
    class H1N1Level_10 : GameScreen
    {
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                pigRow1[a] = row1Pig;
                row1Pig.Position = new Vector2(327 + row1space, 226);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(391 + row2Space, 290);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(775 + row3Space, 290);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(391 + row4Space, 354);
            ...
            for (int e = 0; e < pigRow5.Length; e++)
            {
                ...
                pigRow5[e] = row5Pig;
                row5Pig.Position = new Vector2(775 + row5Space, 354);
            ...
            for (int f = 0; f < pigRow6.Length; f++)
            {
                ...
                pigRow6[f] = row6Pig;
                row6Pig.Position = new Vector2(203 + row6Space, 418);
            ...
            for (int f = 0; f < pigRow7.Length; f++)
            {
                ...
                pigRow7[f] = row7Pig;
                row7Pig.Position = new Vector2(775 + row7Space, 418);
            ...
            for (int x = 0; x < blocks3.Length; x++)
            {
                ...
                blocks3[x] = block3;
                block3.Position = new Vector2(259 + block3RowSpace, 354);
            ...
            for (int i = 0; i < extraLifes.Length; i++)
            {
                ...
                extraLife.Position = new Vector2(164 + extraLifeSpace, 164);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
            ...
            if (hud.Score >= highScore)
            {
                ...
                effectBackground.Stop();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new H1N1Level_11());            
            }
