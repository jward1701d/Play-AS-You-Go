...
namespace Play_As_You_Go
{
    ...
    class H1N1Level_03 : GameScreen
    {
        ...
        GameObject[] pigRow10 = new GameObject[11];
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                pigRow1[a] = row1Pig;
                row1Pig.Position = new Vector2(349 + row1Space, 162);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(317 + row2Space, 226);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(317 + row3Space, 322);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(861 + row4Space, 226);
            ...
            for (int e = 0; e < pigRow5.Length; e++)
            {
                ...
                pigRow5[e] = row5Pig;
                row5Pig.Position = new Vector2(861 + row5Space, 322);
            ...
            for (int f = 0; f < pigRow6.Length; f++)
            {
                ...
                pigRow6[f] = row6Pig;
                row6Pig.Position = new Vector2(584 + row6Space, 290);
            ...
            for (int f = 0; f < pigRow7.Length; f++)
            {
                ...
                pigRow7[f] = row7Pig;
                row7Pig.Position = new Vector2(552 + row7Space, 354);
            ...
            for (int g = 0; g < pigRow8.Length; g++)
            {
                ...
                pigRow8[g] = row8Pig;
                row8Pig.Position = new Vector2(221 + row8Space, 322);
            ...
            for (int g = 0; g < pigRow9.Length; g++)
            {
                ...
                pigRow9[g] = row9Pig;
                row9Pig.Position = new Vector2(253 + row9Space, 386);
            ...
            for (int h = 0; h < pigRow10.Length; h++)
            {
                ...
                pigRow10[h] = row10Pig;
                row10Pig.Position = new Vector2(301 + row10Space, 450);
            ...
            block.Position = new Vector2(621, 226);
            ...
            extraLife.Position = new Vector2(615, 165);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
            ...
            if (hud.Score >= highScore)
            {
                ...
                effectBackground.Stop();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new H1N1Level_04());
            }
