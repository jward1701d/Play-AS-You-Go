    ...
    class H1N1Level_18 : GameScreen
    {
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow6.Length; a++)
            {
                ...
                pigRow6[a] = row6Pig;
                row6Pig.Position = new Vector2(650 + row6Space, 150);
            ...
            for (int a = 0; a < pigRow7.Length; a++)
            {
                ...
                pigRow7[a] = row7Pig;
                row7Pig.Position = new Vector2(650 + row7Space, 214);
            ...
            for (int a = 0; a < pigRow9.Length; a++)
            {
                ...
                pigRow9[a] = row9Pig;
                row9Pig.Position = new Vector2(650 + row9Space, 342);
                row9Pig.Velocity = new Vector2(2, 0f);
            ...
            for (int a = 0; a < pigRow10.Length; a++)
            {
                ...
                pigRow10[a] = row10Pig;
                row10Pig.Position = new Vector2(650 + row10Space, 406);
                row10Pig.Velocity = new Vector2(2, 0f);
            ...
            block1.Position = new Vector2(200, 278);
            ...
            block2.Position = new Vector2(750, 278);
            ...
            extralife1.Position = new Vector2(200, 246);
            ...
            extralife2.Position = new Vector2(750, 246);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
            ...
            foreach (var row4Pigs in pigRow4)
            {
                ...
                if (row4Pigs.Position.X >= 550)
                {
                    row4Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row4Pigs.Position.X <= 150)
                {
                    row4Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            foreach (var row5Pigs in pigRow5)
            {
                ...
                if (row5Pigs.Position.X >= 550)
                {
                    row5Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row5Pigs.Position.X <= 150)
                {
                    row5Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            foreach (var row6Pigs in pigRow6)
            {
                ...
                else if (row6Pigs.Position.X <= 700)
                {
                    row6Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            foreach (var row7Pigs in pigRow7)
            {
                ...
                else if (row7Pigs.Position.X <= 700)
                {
                    row7Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            foreach (var row9Pigs in pigRow9)
            {
                ...
                if (row9Pigs.Position.X >= 1100)
                {
                    row9Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row9Pigs.Position.X <= 700)
                {
                    row9Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            foreach (var row10Pigs in pigRow10)
            {
                ...
                if (row10Pigs.Position.X >= 1100)
                {
                    row10Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row10Pigs.Position.X <= 700)
                {
                    row10Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            if (hud.Score >= highScore)
            {
                ...
                effectBackground.Stop();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new H1N1Level_19());
            }
            ...
            if (block1.Position.X <= 200)
            {
                block1.Velocity = new Vector2(3, 0);
            }
            else if (block1.Position.X >= 500)
            {
                block1.Velocity = new Vector2(-3, 0);
            }
            ...
            if (block2.Position.X <= 750)
            {
                block2.Velocity = new Vector2(3, 0);
            }
            else if (block2.Position.X >= 1030)
            {
                block2.Velocity = new Vector2(-3, 0);
            }
            ...
            if (extralife1.Position.X <= 200)
            {
                extralife1.Velocity = new Vector2(3, 0);
            }
            else if (extralife1.Position.X >= 500)
            {
                extralife1.Velocity = new Vector2(-3, 0);
            }

            extralife2.Update(gameTime);
            if (extralife2.Position.X <= 750)
            {
                extralife2.Velocity = new Vector2(3, 0);
            }
            else if (extralife2.Position.X >= 1030)
            {
                extralife2.Velocity = new Vector2(-3, 0);
            }
