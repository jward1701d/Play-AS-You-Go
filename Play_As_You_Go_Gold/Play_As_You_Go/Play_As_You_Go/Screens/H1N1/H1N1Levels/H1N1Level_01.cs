    ...
    { 
        ...
        public override void Initialize()
        {
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(160 + row2Space, 214);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(120 + row3Space,278);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(160 + row4Space, 342);
            ...
            block1.Position = new Vector2(400, 450);
            ...
            block2.Position = new Vector2(880, 450);
        ...
        {           
            ...
            if (hud.Score >= highScore)
            {
                ...
                effectBackground.Stop();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new H1N1Level_02());
            }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            #region Draw hud and life bar and FPS counter
