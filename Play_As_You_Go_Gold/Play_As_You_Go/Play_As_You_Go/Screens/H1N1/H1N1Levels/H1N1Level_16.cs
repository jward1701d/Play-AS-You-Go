...
namespace Play_As_You_Go
{
    ...
    class H1N1Level_16 : GameScreen
    {
        ...
        public override void Initialize()
        {
            ...
            block.Position = new Vector2(600, 550);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
            ...
            if (hud.Score >= highScore)
            {
                ...
                effectBackground.Stop();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new H1N1Level_17());
            }
            ...
            if (block.Position.X <= 160)
            {
                block.Velocity = new Vector2(3, 0);
            }
            else if (block.Position.X >= 1150)
            {
                block.Velocity = new Vector2(-3, 0);
            }
