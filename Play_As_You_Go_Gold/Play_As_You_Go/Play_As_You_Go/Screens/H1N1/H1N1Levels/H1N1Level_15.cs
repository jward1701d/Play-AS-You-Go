...
namespace Play_As_You_Go
{
    ...
    class H1N1Level_15 : GameScreen
    {
        ...
        // Game Objects
        GameObject bars, background, paddle, paddleColision, block1, block2, block3, block4, extralife1, extralife2;
        ...
        GameObject[] pigRow6 = new GameObject[1]; // Keep at 1.
        GameObject[] pigRow7 = new GameObject[2];
        GameObject[] pigRow8 = new GameObject[1];
        GameObject[] pigRow9 = new GameObject[1];
        GameObject[] pigRow10 = new GameObject[2];
        GameObject[] pigRow11 = new GameObject[1];
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                pigRow1[a] = row1Pig;
                row1Pig.Position = new Vector2(509 + row1Space, 150);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(573 + row2Space, 214);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(605 + row3Space, 278);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(605 + row4Space, 450);
            ...
            for (int a = 0; a < pigRow5.Length; a++)
            {
                ...
                pigRow5[a] = row5Pig;
                row5Pig.Position = new Vector2(509 + row5Space, 514);
            ...
            for (int a = 0; a < pigRow6.Length; a++)
            {
                ...
                pigRow6[a] = row6Pig;
                row6Pig.Position = new Vector2(300 + row6Space, 290);
            ...
            for (int a = 0; a < pigRow7.Length; a++)
            {
                ...
                pigRow7[a] = row7Pig;
                row7Pig.Position = new Vector2(300 + row7Space, 354);
            ...
            for (int a = 0; a < pigRow8.Length; a++)
            {
                ...
                pigRow8[a] = row8pig;
                row8pig.Position = new Vector2(300 + row8Space, 418);
            ...
            for (int a = 0; a < pigRow9.Length; a++)
            {
                ...
                pigRow9[a] = row9pig;
                row9pig.Position = new Vector2(975 + row9Space, 290);
            ...
            for (int a = 0; a < pigRow10.Length; a++)
            {
                ...
                pigRow10[a] = row10pig;
                row10pig.Position = new Vector2(911 + row10Space, 354);
            ...
            // Initialize top row of pigs and give it a positon, origin, scale and active to true
            for (int a = 0; a < pigRow11.Length; a++)
            {
                GameObject row11pig = new GameObject(SpriteSheet, new Rectangle(760, 188, 256, 256), 1, true, 0);
                pigRow11[a] = row11pig;
                row11pig.Position = new Vector2(975 + row11Space, 418);
                row11pig.Origin = new Vector2((row11pig.ActualWidth / 2) / row11pig.Scale, (row11pig.ActualHeight / 2) / row11pig.Scale);
                row11pig.Scale = 0.125f;
                row11pig.Active = true;
                row11Space += 64;
            }
            ...
            block1.Position = new Vector2(175, 150);
            ...
            block2.Position = new Vector2(1100, 150);
            ...
            block3.Position = new Vector2(175, 250);
            block3.Velocity = new Vector2(0, 0.9f);
            block3.Origin = new Vector2((block2.ActualWidth / 2) / block2.Scale, (block2.ActualHeight / 2) / block2.Scale);
            block3.Scale = 1.0f;

            block4 = new GameObject(SpriteSheet, new Rectangle(14, 26, 160, 32), 1, true, 0);
            block4.Position = new Vector2(1100, 250);
            block4.Velocity = new Vector2(0, 0.9f);
            block4.Origin = new Vector2((block2.ActualWidth / 2) / block2.Scale, (block2.ActualHeight / 2) / block2.Scale);
            block4.Scale = 1.0f;
            #endregion

            #region extralife Initialize

            extralife1 = new GameObject(SpriteSheet, new Rectangle(192, 11, 256, 256), 2, true, 0);
            extralife1.AnimationSpeed = TimeSpan.FromMilliseconds(600);
            extralife1.Position = new Vector2(175,218);
            extralife1.Velocity = new Vector2(0, 0.9f);
            extralife1.Origin = new Vector2((extralife1.ActualWidth / 2) / extralife1.Scale, (extralife1.ActualHeight / 2) / extralife1.Scale);
            extralife1.Scale = 0.15f;

            extralife2 = new GameObject(SpriteSheet, new Rectangle(192, 11, 256, 256), 2, true, 0);
            extralife2.AnimationSpeed = TimeSpan.FromMilliseconds(600);
            extralife2.Position = new Vector2(1100, 218);
            extralife2.Velocity = new Vector2(0, 0.9f);
            extralife2.Origin = new Vector2((extralife2.ActualWidth / 2) / extralife2.Scale, (extralife2.ActualHeight / 2) / extralife2.Scale);
            extralife2.Scale = 0.15f;
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
            ...
            foreach (var row11Pigs in pigRow11)
            {
                if (row11Pigs.Active)
                    row11PigCollision();
                row11Pigs.Update(gameTime);
            }
            #endregion
            ...
            if (hud.Score >= highScore)
            {
                ...
                effectBackground.Stop();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new H1N1Level_16());               
            }
            ...
            if (block3.Position.Y >= 450)
            {
                block3.Velocity = new Vector2(0, -0.9f);
            }
            else if (block3.Position.Y <= 250)
            {
                block3.Velocity = new Vector2(0, 0.9f);
            }
            ...
            if (block4.Position.Y >= 450)
            {
                block4.Velocity = new Vector2(0, -0.9f);
            }
            else if (block4.Position.Y <= 250)
            {
                block4.Velocity = new Vector2(0, 0.9f);
            }
            ...
            #region extralife Update

            extralife1.Update(gameTime);
            if (extralife1.Position.Y >= 418)
            {
                extralife1.Velocity = new Vector2(0, -0.9f);
            }
            else if (extralife1.Position.Y <= 218)
            {
                extralife1.Velocity = new Vector2(0, 0.9f);
            }

            extralife2.Update(gameTime);
            if (extralife2.Position.Y >= 418)
            {
                extralife2.Velocity = new Vector2(0, -0.9f);
            }
            else if (extralife2.Position.Y <= 218)
            {
                extralife2.Velocity = new Vector2(0, 0.9f);
            }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            #region Draw extralife

            extralife1.Draw(gameTime, spriteBatch);
            extralife2.Draw(gameTime, spriteBatch);
        ...
        #region row11Pig Collision

        private void row11PigCollision()
        {
            foreach (var row11Pig in pigRow11)
            {
                if (row11Pig == null)
                ...
                foreach (var ball in balls)
                {
                    if (ball.BoundingRect.Intersects(row11Pig.BoundingRect))
                    {
                        hud.Score = hud.Score + 10;
                        ...
                        Vector2[] corners = new Vector2[4];
                        corners[0] = new Vector2(row11Pig.Position.X - row11Pig.Origin.X * row11Pig.Scale, row11Pig.Position.Y - row11Pig.Origin.Y * row11Pig.Scale);
                        corners[1] = new Vector2(row11Pig.Position.X + row11Pig.Origin.X * row11Pig.Scale, row11Pig.Position.Y - row11Pig.Origin.Y * row11Pig.Scale);
                        corners[2] = new Vector2(row11Pig.Position.X + row11Pig.Origin.X * row11Pig.Scale, row11Pig.Position.Y + row11Pig.Origin.Y * row11Pig.Scale);
                        corners[3] = new Vector2(row11Pig.Position.X - row11Pig.Origin.X * row11Pig.Scale, row11Pig.Position.Y + row11Pig.Origin.Y * row11Pig.Scale);

                        this.CornerMarkers = new float[4];

                        for (int i = 1; i < CornerMarkers.Length; i++)
                        {
                            Vector2 direction = Vector2.Normalize(corners[i] - row11Pig.Position);
                            CornerMarkers[i] = (float)Math.Atan2(direction.Y, direction.X) + MathHelper.Pi;
                        }

                        Vector2 direction2 = Vector2.Normalize(ball.Position - row11Pig.Position);
                        ...
                        row11Pig.Active = false;
                        row11Pig.Position = new Vector2(1300, 800);
                    }
                }
            }
        }
        ...
        private void extraLifeCollision1()
        {
            foreach (var ball in balls)
            {
                if (ball.BoundingRect.Intersects(extralife1.BoundingRect))
                {
                    extralife1.Active = false;
                    extralife1.Position = new Vector2(1300, 750);
                    extralife1.Velocity = new Vector2(0, 0);
        ...
        private void extraLifeCollision2()
        {
            foreach (var ball in balls)
            {
                if (ball.BoundingRect.Intersects(extralife2.BoundingRect))
                {
                    extralife2.Active = false;
                    extralife2.Position = new Vector2(1300, 750);
                    extralife2.Velocity = new Vector2(0, 0);
