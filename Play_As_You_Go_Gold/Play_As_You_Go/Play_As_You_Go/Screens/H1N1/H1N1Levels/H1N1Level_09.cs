    ...
    class H1N1Level_09 : GameScreen
    {
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                pigRow1[a] = row1Pig;
                row1Pig.Position = new Vector2(255 + row1space, 162);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(287 + row2Space, 226);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(451 , 290 + row3Space);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(547 , 290 + row4Space);
            ...
            for (int e = 0; e < pigRow5.Length; e++)
            {
                ...
                pigRow5[e] = row5Pig;
                row5Pig.Position = new Vector2(739, 290 + row5Space);
            ...
            for (int f = 0; f < pigRow6.Length; f++)
            {
                ...
                pigRow6[f] = row6Pig;
                row6Pig.Position = new Vector2(835 , 290 + row6Space);
            ...
            for (int f = 0; f < pigRow7.Length; f++)
            {
                ...
                pigRow7[f] = row7Pig;
                row7Pig.Position = new Vector2(499  + row7Space, 322);
            ...
            for (int f = 0; f < pigRow8.Length; f++)
            {
                ...
                pigRow8[f] = row8Pig;
                row8Pig.Position = new Vector2(227 + row8Space, 386);
            ...
            for (int f = 0; f < pigRow9.Length; f++)
            {
                ...
                pigRow9[f] = row9Pig;
                row9Pig.Position = new Vector2(928 + row9Space, 386);
            ...
            for (int x = 0; x < blocks2.Length; x++)
            {
                ...
                blocks2[x] = block2;
                block2.Position = new Vector2(291 + block2RowSpace, 290);
            ...
            for (int x = 0; x < blocks3.Length; x++)
            {
                ...
                blocks3[x] = block3;
                block3.Position = new Vector2(259 + block3RowSpace, 482);
            ...
            for (int i = 0; i < extraLifes.Length; i++)
            {
                ...
                extraLife.Position = new Vector2(132 + extraLifeSpace, 164);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
            ...
            if (hud.Score >= highScore)
            {
                ...
                effectBackground.Stop();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new H1N1Level_10());
