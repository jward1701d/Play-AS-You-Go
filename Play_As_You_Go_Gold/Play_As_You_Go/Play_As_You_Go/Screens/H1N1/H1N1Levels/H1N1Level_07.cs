    ...
    class H1N1Level_07 : GameScreen
    {
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                pigRow1[a] = row1Pig;
                row1Pig.Position = new Vector2(196 + row1space, 162);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(132 + row2Space, 226);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(132 , 322 + row3Space);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(196, 290 + row4Space);
            ...
            for (int e = 0; e < pigRow5.Length; e++)
            {
                ...
                pigRow5[e] = row5Pig;
                row5Pig.Position = new Vector2(260 , 322 + row5Space);
            ...
            for (int f = 0; f < pigRow6.Length; f++)
            {
                ...
                pigRow6[f] = row6Pig;
                row6Pig.Position = new Vector2(452 , 290 + row6Space);
            ...
            for (int f = 0; f < pigRow7.Length; f++)
            {
                ...
                pigRow7[f] = row7Pig;
                row7Pig.Position = new Vector2(836 , 290 + row7Space);
            ...
            for (int f = 0; f < pigRow8.Length; f++)
            {
                ...
                pigRow8[f] = row8Pig;
                row8Pig.Position = new Vector2(1028 , 322 + row8Space);
            ...
            for (int f = 0; f < pigRow9.Length; f++)
            {
                ...
                pigRow9[f] = row9Pig;
                row9Pig.Position = new Vector2(1092, 290 + row9Space);
            ...
            for (int f = 0; f < pigRow10.Length; f++)
            {
                ...
                pigRow10[f] = row10Pig;
                row10Pig.Position = new Vector2(1156, 322 + row10Space);
            ...
            for (int x = 0; x < blocks1.Length; x++)
            {
                ...
                blocks1[x] = block1;
                block1.Position = new Vector2(644 , 290 + block1ColSpace);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
            ...
            if (hud.Score >= highScore)
            {
                ...
                effectBackground.Stop();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new H1N1Level_08());                
            }
