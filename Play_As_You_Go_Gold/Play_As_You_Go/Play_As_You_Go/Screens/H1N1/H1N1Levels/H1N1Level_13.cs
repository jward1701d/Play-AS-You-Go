...
namespace Play_As_You_Go
{
    ...
    class H1N1Level_13 : GameScreen
    {
        ...
        // Game Objects
        GameObject bars, background, paddle, paddleColision, block1, block2, block3, extraLife;
        ...
        GameObject[] pigRow7 = new GameObject[5];
        ...
        public override void Initialize()
        {
            ...
            paddle.Position = new Vector2(675, 652);
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                pigRow1[a] = row1Pig;
                row1Pig.Position = new Vector2(300 + row1Space, 150);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(236 + row2Space, 214);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(172 + row3Space, 278);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(236 + row4Space, 342);
            ...
            for (int a = 0; a < pigRow5.Length; a++)
            {
                ...
                pigRow5[a] = row5Pig;
                row5Pig.Position = new Vector2(300 + row5Space, 406);
            ...
            for (int a = 0; a < pigRow6.Length; a++)
            {
                ...
                pigRow6[a] = row6Pig;
                row6Pig.Position = new Vector2(935 + row6Space, 214);
            ...
            for (int a = 0; a < pigRow7.Length; a++)
            {
                ...
                pigRow7[a] = row7Pig;
                row7Pig.Position = new Vector2(871 + row7Space, 278);
            ...
            for (int a = 0; a < pigRow8.Length; a++)
            {
                ...
                pigRow8[a] = row8pig;
                row8pig.Position = new Vector2(935 + row8Space, 342);
            ...
            block1.Position = new Vector2(560, 500);
            ...
            block2.Position = new Vector2(720, 500);
            ...
            block3.Position = new Vector2(640, 468);
            block3.Velocity = new Vector2(0, -2);
            ...
            extraLife.Position = new Vector2(640, 435);
            extraLife.Velocity = new Vector2(0, -2);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
            ...
            if (hud.Score >= highScore)
            {
                ...
                effectBackground.Stop();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new H1N1Level_14());
            }
            ...
            if (block2.Position.X <= 720)
            {
                block2.Velocity = new Vector2(3, 0);
            }
            else if (block2.Position.X >= 1120)
            {
                block2.Velocity = new Vector2(-3, 0);
            }
            ...
            if (block3.Position.Y <= 162)
            {
                block3.Velocity = new Vector2(0, 2);
            }
            else if (block3.Position.Y >= 468)
            {
                block3.Velocity = new Vector2(0, -2);
            }
            ...
            if (extraLife.Position.Y <= 130)
            {
                extraLife.Velocity = new Vector2(0, 2);
            }

            else if (extraLife.Position.Y >= 435)
            {
                extraLife.Velocity = new Vector2(0, -2);
            }
        ...
        private void CheckBlock3Collision()
        {
            ...
            foreach (var ball in balls)
            {
                if (ball.BoundingRect.Intersects(block3.BoundingRect))
                {
                    ...
                    Vector2[] block2Corners = new Vector2[4];
                    block2Corners[0] = new Vector2(block3.Position.X - block3.Origin.X * block3.Scale, block3.Position.Y - block3.Origin.Y * block3.Scale);
                    block2Corners[1] = new Vector2(block3.Position.X + block3.Origin.X * block3.Scale, block3.Position.Y - block3.Origin.Y * block3.Scale);
                    block2Corners[2] = new Vector2(block3.Position.X + block3.Origin.X * block3.Scale, block3.Position.Y + block3.Origin.Y * block3.Scale);
                    block2Corners[3] = new Vector2(block3.Position.X - block3.Origin.X * block3.Scale, block3.Position.Y + block3.Origin.Y * block3.Scale);

                    Block3CornerMarkers = new float[4];

                    for (int i = 1; i < Block3CornerMarkers.Length; i++)
                    {
                        Vector2 direction = Vector2.Normalize(block2Corners[i] - block3.Position);
        ...
        private void extraLifeCollision()
        {
            foreach (var ball in balls)
            {
                if (ball.BoundingRect.Intersects(extraLife.BoundingRect))
                {
                    ...
                    extraLife.Velocity = new Vector2(0, 0);
