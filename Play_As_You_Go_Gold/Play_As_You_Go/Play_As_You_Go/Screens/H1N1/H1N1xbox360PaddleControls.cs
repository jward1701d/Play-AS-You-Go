...
{
    class H1N1Xbo360PadddleControlsScreen : MenuScreen
    {
        ...
        public H1N1Xbo360PadddleControlsScreen()
        {
            transitionTime = 1.5f;
        ...
        public override void Initialize()
        {
            ...
            controlsPosition = new Vector2(-50, 0);

            title = "Xbox 360 paddle controls";
        ...
        public override void LoadContent()
        {
            ...
            PaddleControlBackground = content.Load<Texture2D>("Backgrounds/H1N1Backgrounds/XboxControlsBackground");
