...
{
    public class BSLevel1 : GameScreen
    {
        #region Fields
        ...
        GameObject[] EnemyType5 = new GameObject[2];
        ...
        /// Constructor
        /// </summary>
        public BSLevel1(int sc, int life, bool blaster, int numMissles)
        {
            score = sc;
            lives = life;
        ...
        public override void LoadContent()
        {
            ...
            music = content.Load<SoundEffect>("Audio/BSAudio/outer");
        ...
        void LoadLevel()
        {
            backgroundMusic.Stop();
            base.Remove();
            LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new BSLevel2(score, lives, doubleBlaster, numMissles, blasterBonus, missleBonus, toBlasterBonus, toMissleBonus));
        }//end load level
