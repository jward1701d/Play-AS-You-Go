...
namespace Play_As_You_Go
{
    public class BSLevel20 : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (bEnd)
            {
                spriteBatch.DrawString(TitleFont, "Game complete!", new Vector2(550, 360), Color.Firebrick);
        ...
        void LoadLevel()
        {
            ...
            if (isolatedStorage.isSaveable)
            {
                LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new HighScoreInterface(Data, score, level, HighScore, 1));
            }
            else
                LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new BSMainMenu());
        }//end load level
