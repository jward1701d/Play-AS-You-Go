...
namespace Play_As_You_Go
{
    public class BSLevel15 : GameScreen
    {
        ...
        void LoadLevel()
        {
            backgroundMusic.Stop();
            base.Remove();
            LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new BSLevel16(score, lives, doubleBlaster, numMissles, blasterBonus, missleBonus, toBlasterBonus, toMissleBonus));
        }//end load level
