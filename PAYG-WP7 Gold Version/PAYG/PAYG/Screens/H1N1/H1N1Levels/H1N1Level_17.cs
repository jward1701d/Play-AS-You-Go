...
namespace PAYG
{
    ...
    class H1N1Level_17 : GameScreen
    {
        ...
        // Game Objects
        GameObject bars, background, paddle, paddleColision, block1;
        ...
        public H1N1Level_17(bool active)
        {
            TransitionOnTime = TimeSpan.FromSeconds(2);
            TransitionOffTime = TimeSpan.FromSeconds(1);
            didRestart = active;
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow7.Length; a++)
            {
                ...
                pigRow7[a] = row7Pig;
                row7Pig.Position = new Vector2(465 + row7Space, 255);
            ...
            for (int a = 0; a < pigRow8.Length; a++)
            {
                ...
                pigRow8[a] = row8Pig;
                row8Pig.Position = new Vector2(465 + row8Space, 300);
            ...
            block1.Position = new Vector2(400, 215);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
          ...
          Accelerometer.GetState().Acceleration.Y, Accelerometer.GetState().Acceleration.Z);
            ...
            if (hud.Score >= highScore)
            {
                ...
                ScreenManager.RemoveAd();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, new H1N1Level_18());                
            }
            ...
            if (block1.Position.X <= 90)
            {
                block1.Velocity = new Vector2(3, 0);
            }
            else if (block1.Position.X >= 710)
            {
                block1.Velocity = new Vector2(-3, 0);
            }
