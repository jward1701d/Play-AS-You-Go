...
namespace PAYG
{
    ...
    class H1N1Level_07 : GameScreen
    {
        ...
        GameObject[] pigRow1 = new GameObject[15];
        GameObject[] pigRow2 = new GameObject[17];
        ...
        GameObject[] pigRow7 = new GameObject[3];
        ...
        public H1N1Level_07(bool active)
        {
            TransitionOnTime = TimeSpan.FromSeconds(2);
            TransitionOffTime = TimeSpan.FromSeconds(1);
            didRestart = active;
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                pigRow1[a] = row1Pig;
                row1Pig.Position = new Vector2(85 + row1space, 100);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(40 + row2Space, 135);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(40 , 200 + row3Space);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(85, 185 + row4Space);
            ...
            for (int e = 0; e < pigRow5.Length; e++)
            {
                ...
                pigRow5[e] = row5Pig;
                row5Pig.Position = new Vector2(130 , 200 + row5Space);
            ...
            for (int f = 0; f < pigRow6.Length; f++)
            {
                ...
                pigRow6[f] = row6Pig;
                row6Pig.Position = new Vector2(300 , 180 + row6Space);
            ...
            for (int f = 0; f < pigRow7.Length; f++)
            {
                ...
                pigRow7[f] = row7Pig;
                row7Pig.Position = new Vector2(500 , 180 + row7Space);
            ...
            for (int f = 0; f < pigRow8.Length; f++)
            {
                ...
                pigRow8[f] = row8Pig;
                row8Pig.Position = new Vector2(660 , 200 + row8Space);
            ...
            for (int f = 0; f < pigRow9.Length; f++)
            {
                ...
                pigRow9[f] = row9Pig;
                row9Pig.Position = new Vector2(705, 185 + row9Space);
            ...
            // Initialize row 10 of pigs and give it a positon, origin, scale and active to true
            for (int f = 0; f < pigRow10.Length; f++)
            {
                GameObject row10Pig = new GameObject(SpriteSheet, new Rectangle(760, 188, 256, 256), 1, true, 0);
                pigRow10[f] = row10Pig;
                row10Pig.Position = new Vector2(750, 200 + row10Space);
            ...
            for (int x = 0; x < blocks1.Length; x++)
            {
                ...
                blocks1[x] = block1;
                block1.Position = new Vector2(400 , 180 + block1ColSpace);
            ...
            for (int i = 0; i < extraLifes.Length; i++)
            {
                ...
                extraLife.Position = new Vector2(400, 250);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
          ...
          Accelerometer.GetState().Acceleration.Y, Accelerometer.GetState().Acceleration.Z);
            ...
            if (hud.Score >= highScore)
            {
                ...
                ScreenManager.RemoveAd();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, new H1N1Level_08());
            }
