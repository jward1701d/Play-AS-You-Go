...
namespace PAYG
{
    ...
    class H1N1Level_18 : GameScreen
    {
        ...
        // Game Objects
        GameObject bars, background, paddle, paddleColision, block1, block2, extralife1, extralife2;

        GameObject[] balls = new GameObject[1];

        GameObject[] pigRow1 = new GameObject[7];
        GameObject[] pigRow2 = new GameObject[7];
        GameObject[] pigRow3 = new GameObject[7];
        GameObject[] pigRow4 = new GameObject[7];
        GameObject[] pigRow5 = new GameObject[7];
        GameObject[] pigRow6 = new GameObject[7];
        GameObject[] pigRow7 = new GameObject[7];
        ...
        public H1N1Level_18(bool active)
        {
            TransitionOnTime = TimeSpan.FromSeconds(2);
            TransitionOffTime = TimeSpan.FromSeconds(1);
            didRestart = active;
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                pigRow1[a] = row1Pig;
                row1Pig.Position = new Vector2(65 + row1Space, 100);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(65 + row2Space, 145);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(65 + row3Space, 285);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(65 + row4Space, 330);
                row4Pig.Velocity = new Vector2(2, 0f);
            ...
            for (int a = 0; a < pigRow5.Length; a++)
            {
                ...
                pigRow5[a] = row5Pig;
                row5Pig.Position = new Vector2(465 + row5Space, 100);
                row5Pig.Velocity = new Vector2(2, 0f);
            ...
            for (int a = 0; a < pigRow6.Length; a++)
            {
                ...
                pigRow6[a] = row6Pig;
                row6Pig.Position = new Vector2(465 + row6Space, 145);
            ...
            for (int a = 0; a < pigRow7.Length; a++)
            {
                ...
                pigRow7[a] = row7Pig;
                row7Pig.Position = new Vector2(465 + row7Space, 285);
                row7Pig.Velocity = new Vector2(2, 0f);
            ...
            for (int a = 0; a < pigRow8.Length; a++)
            {
                ...
                pigRow8[a] = row8Pig;
                row8Pig.Position = new Vector2(465 + row8Space, 330);
            ...
            block1.Position = new Vector2(100, 245);
            ...
            block2.Position = new Vector2(750, 245);
            ...
            extralife1.Position = new Vector2(85, 215);
            extralife1.Velocity = new Vector2(-3, 0);
            ...
            extralife2.Position = new Vector2(735, 215);
            extralife2.Velocity = new Vector2(-3, 0);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
          ...
          Accelerometer.GetState().Acceleration.Y, Accelerometer.GetState().Acceleration.Z);
            ...
            foreach (var row1Pigs in pigRow1)
            {
                ...
                if (row1Pigs.Position.X >= 350)
                {
                    row1Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row1Pigs.Position.X <= 65)
                {
                    row1Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            foreach (var row2Pigs in pigRow2)
            {
                ...
                if (row2Pigs.Position.X >= 350)
                {
                    row2Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row2Pigs.Position.X <= 65)
                {
                    row2Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            foreach (var row3Pigs in pigRow3)
            {
                ...
                if (row3Pigs.Position.X >= 350)
                {
                    row3Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row3Pigs.Position.X <= 65)
                {
                    row3Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            foreach (var row4Pigs in pigRow4)
            {
                ...
                if (row4Pigs.Position.X >= 350)
                {
                    row4Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row4Pigs.Position.X <= 65)
                {
                    row4Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            foreach (var row5Pigs in pigRow5)
            {
                ...
                if (row5Pigs.Position.X >= 750)
                {
                    row5Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row5Pigs.Position.X <= 465)
                {
                    row5Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            foreach (var row6Pigs in pigRow6)
            {
                ...
                if (row6Pigs.Position.X >= 750)
                {
                    row6Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row6Pigs.Position.X <= 465)
                {
                    row6Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            foreach (var row7Pigs in pigRow7)
            {
                ...
                if (row7Pigs.Position.X >= 750)
                {
                    row7Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row7Pigs.Position.X <= 465)
                {
                    row7Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            foreach (var row8Pigs in pigRow8)
            {
                ...
                if (row8Pigs.Position.X >= 750)
                {
                    row8Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row8Pigs.Position.X <= 465)
                {
                    row8Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            if (hud.Score >= highScore)
            {
                ...
                ScreenManager.RemoveAd();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, new H1N1Level_19());
            }
            ...
            if (block2.Position.X <= 450)
            {
                block2.Velocity = new Vector2(3, 0);
            }
            else if (block2.Position.X >= 720)
            {
                block2.Velocity = new Vector2(-3, 0);
            }
            ...
            if (extralife1.Position.X <= 95)
            {
                extralife1.Velocity = new Vector2(3, 0);
            }
            else if (extralife1.Position.X >= 333)
            {
                extralife1.Velocity = new Vector2(-3, 0);
            }

            extralife2.Update(gameTime);
            if (extralife2.Position.X <= 435)
            {
                extralife2.Velocity = new Vector2(3, 0);
            }
            else if (extralife2.Position.X >= 705)
            {
                extralife2.Velocity = new Vector2(-3, 0);
            }
        ...
        protected void SaveState(object sender, DeactivatedEventArgs args)
        {
            ...
            PhoneApplicationService.Current.State["extralife1"] = extralife1;
            PhoneApplicationService.Current.State["extralife2"] = extralife2;
        ...
        public void LoadLevel()
        {
            ...
            GameObject extralife1Load = (GameObject)PhoneApplicationService.Current.State["extralife1"];
            extralife1.Position = extralife1Load.Position;
            extralife1.Velocity = extralife1Load.Velocity;
            extralife1.AnimationSpeed = TimeSpan.FromMilliseconds(600);

            GameObject extralife2Load = (GameObject)PhoneApplicationService.Current.State["extralife2"];
            extralife2.Position = extralife2Load.Position;
            extralife2.Velocity = extralife2Load.Velocity;
            extralife2.AnimationSpeed = TimeSpan.FromMilliseconds(600); 
            ...
            for (int i = 0; i < pigRow7.Length; i++)
            {
                ...
                pigRow7[i].Velocity = row7pigs[i].Velocity;
                pigRow7[i].Scale = row7pigs[i].Scale;
            }
            ...
            for (int i = 0; i < pigRow8.Length; i++)
            {
                ...
                pigRow8[i].Velocity = row8pigs[i].Velocity;
                pigRow8[i].Scale = row8pigs[i].Scale;
            }
