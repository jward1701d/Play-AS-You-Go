...
namespace PAYG
{
    ...
    class H1N1Level_15 : GameScreen
    {
        ...
        GameObject[] pigRow6 = new GameObject[3]; 
        GameObject[] pigRow7 = new GameObject[2];
        GameObject[] pigRow8 = new GameObject[3];
        ...
        public H1N1Level_15(bool active)
        {
            TransitionOnTime = TimeSpan.FromSeconds(2);
            TransitionOffTime = TimeSpan.FromSeconds(1);
            didRestart = active;
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                pigRow1[a] = row1Pig;
                row1Pig.Position = new Vector2(300 + row1Space, 100);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(345 + row2Space, 145);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(370 + row3Space, 190);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(390 + row4Space,330);
            ...
            for (int a = 0; a < pigRow5.Length; a++)
            {
                ...
                pigRow5[a] = row5Pig;
                row5Pig.Position = new Vector2(320 + row5Space, 375);
            ...
            for (int a = 0; a < pigRow6.Length; a++)
            {
                ...
                pigRow6[a] = row6Pig;
                row6Pig.Position = new Vector2(200 , 253 + row6Space);
            ...
            for (int a = 0; a < pigRow7.Length; a++)
            {
                ...
                pigRow7[a] = row7Pig;
                row7Pig.Position = new Vector2(245 + row7Space, 300);
            ...
            for (int a = 0; a < pigRow8.Length; a++)
            {
                ...
                pigRow8[a] = row8pig;
                row8pig.Position = new Vector2(600, 253 + row8Space);
            ...
            block3.Position = new Vector2(100, 150);
            ...
            block4.Position = new Vector2(700, 150);
            ...
            extralife1.Position = new Vector2(95,120);
            ...
            extralife2.Position = new Vector2(700, 120);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
          ...
          Accelerometer.GetState().Acceleration.Y, Accelerometer.GetState().Acceleration.Z);
            ...
            if (hud.Score >= highScore)
            {
                ...
                ScreenManager.RemoveAd();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, new H1N1Level_16());                
            }
            ...
            if (block3.Position.Y >= 330)
            {
                block3.Velocity = new Vector2(0, -0.9f);
            }
            else if (block3.Position.Y <= 150)
            {
                block3.Velocity = new Vector2(0, 0.9f);
            }
            ...
            if (block4.Position.Y >= 330)
            {
                block4.Velocity = new Vector2(0, -0.9f);
            }
            else if (block4.Position.Y <= 150)
            {
                block4.Velocity = new Vector2(0, 0.9f);
            }
            ...
            if (extralife1.Position.Y >= 300)
            {
                extralife1.Velocity = new Vector2(0, -0.9f);
            }
            else if (extralife1.Position.Y <= 120)
            {
                extralife1.Velocity = new Vector2(0, 0.9f);
            }

            extralife2.Update(gameTime);
            if (extralife2.Position.Y >= 300)
            {
                extralife2.Velocity = new Vector2(0, -0.9f);
            }
            else if (extralife2.Position.Y <= 120)
            {
                extralife2.Velocity = new Vector2(0, 0.9f);
            }
