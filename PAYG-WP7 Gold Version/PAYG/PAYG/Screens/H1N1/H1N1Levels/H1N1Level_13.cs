...
namespace PAYG
{
    ...
    class H1N1Level_13 : GameScreen
    {
        ...
        public H1N1Level_13(bool active)
        {
            TransitionOnTime = TimeSpan.FromSeconds(2);
            TransitionOffTime = TimeSpan.FromSeconds(1);
            didRestart = active;
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                pigRow1[a] = row1Pig;
                row1Pig.Position = new Vector2(150 + row1Space, 100);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(105 + row2Space, 145);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(60 + row3Space, 190);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(105 + row4Space, 235);
            ...
            for (int a = 0; a < pigRow5.Length; a++)
            {
                ...
                pigRow5[a] = row5Pig;
                row5Pig.Position = new Vector2(150 + row5Space, 280);
            ...
            for (int a = 0; a < pigRow6.Length; a++)
            {
                ...
                pigRow6[a] = row6Pig;
                row6Pig.Position = new Vector2(595 + row6Space, 145);
            ...
            for (int a = 0; a < pigRow7.Length; a++)
            {
                ...
                pigRow7[a] = row7Pig;
                row7Pig.Position = new Vector2(550 + row7Space, 190);
            ...
            for (int a = 0; a < pigRow8.Length; a++)
            {
                ...
                pigRow8[a] = row8pig;
                row8pig.Position = new Vector2(595 + row8Space, 235);
            ...
            block1.Position = new Vector2(340, 375);
            ...
            block2.Position = new Vector2(460, 375);
            ...
            block3.Position = new Vector2(400, 150);
            ...
            extraLife.Position = new Vector2(400, 120);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
          ...
          Accelerometer.GetState().Acceleration.Y, Accelerometer.GetState().Acceleration.Z);
            ...
            if (hud.Score >= highScore)
            {
                ...
                ScreenManager.RemoveAd();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, new H1N1Level_14());
            }
            ...
            if (block1.Position.X <= 80)
            {
                block1.Velocity = new Vector2(3, 0);
            }
            else if (block1.Position.X >= 340)
            {
                block1.Velocity = new Vector2(-3, 0);
            }
            ...
            if (extraLife.Position.Y <= 120)
            {
                extraLife.Velocity = new Vector2(0, 2);
            }

            else if (extraLife.Position.Y >= 300)
            {
                extraLife.Velocity = new Vector2(0, -2);
            }
