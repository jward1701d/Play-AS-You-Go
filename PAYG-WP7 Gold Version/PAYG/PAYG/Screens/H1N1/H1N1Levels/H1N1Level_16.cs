...
namespace PAYG
{
    ...
    class H1N1Level_16 : GameScreen
    {
        ...
        // Game Objects
        GameObject bars, background, paddle, paddleColision, block;
        ...
        GameObject[] pigRow9 = new GameObject[7];
        GameObject[] pigRow10 = new GameObject[7];
        ...
        public H1N1Level_16(bool active)
        {
            TransitionOnTime = TimeSpan.FromSeconds(2);
            TransitionOffTime = TimeSpan.FromSeconds(1);
            didRestart = active;
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                row1Pig.Velocity = new Vector2(2, 0);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                row2Pig.Velocity = new Vector2(2, 0);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(65 + row3Space, 190);
                row3Pig.Velocity = new Vector2(2, 0);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(65 + row4Space, 235);
                row4Pig.Velocity = new Vector2(2, 0);
            ...
            for (int a = 0; a < pigRow5.Length; a++)
            {
                ...
                pigRow5[a] = row5Pig;
                row5Pig.Position = new Vector2(65 + row5Space, 280);
                row5Pig.Velocity = new Vector2(2, 0);
            ...
            for (int a = 0; a < pigRow6.Length; a++)
            {
                ...
                pigRow6[a] = row6Pig;
                row6Pig.Position = new Vector2(465 + row6Space, 100);
                row6Pig.Velocity = new Vector2(2, 0);
            ...
            for (int a = 0; a < pigRow7.Length; a++)
            {
                ...
                pigRow7[a] = row7Pig;
                row7Pig.Position = new Vector2(465 + row7Space, 145);
            ...
            for (int a = 0; a < pigRow8.Length; a++)
            {
                ...
                pigRow8[a] = row8Pig;
                row8Pig.Position = new Vector2(465 + row8Space, 190);
            ...
            for (int a = 0; a < pigRow9.Length; a++)
            {
                ...
                pigRow9[a] = row9Pig;
                row9Pig.Position = new Vector2(465 + row9Space, 235);
                row9Pig.Velocity = new Vector2(2, 0);
            ...
            for (int a = 0; a < pigRow10.Length; a++)
            {
                ...
                pigRow10[a] = row10Pig;
                row10Pig.Position = new Vector2(465 + row10Space, 280);
                row10Pig.Velocity = new Vector2(2, 0);
            ...
            block.Position = new Vector2(400, 370);
            block.Velocity = new Vector2(-3, 0);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
          ...
          Accelerometer.GetState().Acceleration.Y, Accelerometer.GetState().Acceleration.Z);
            ...
            foreach (var row5Pigs in pigRow5)
            {
                ...
                if (row5Pigs.Position.X >= 350)
                {
                    row5Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row5Pigs.Position.X <= 65)
                {
                    row5Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            foreach (var row9Pigs in pigRow9)
            {
                ...
                if (row9Pigs.Position.X >= 750)
                {
                    row9Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row9Pigs.Position.X <= 465)
                {
                    row9Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            foreach (var row10Pigs in pigRow10)
            {
                ...
                if (row10Pigs.Position.X >= 750)
                {
                    row10Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row10Pigs.Position.X <= 465)
                {
                    row10Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            if (hud.Score >= highScore)
            {
                ...
                ScreenManager.RemoveAd();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, new H1N1Level_17());
            }
            ...
            if (block.Position.X <= 90)
            {
                block.Velocity = new Vector2(3, 0);
            }
            else if (block.Position.X >= 710)
            {
                block.Velocity = new Vector2(-3, 0);
            }
        ...
        private void CheckBlockCollision()
        {
            ...
            foreach (var ball in balls)
            {
                if (ball.BoundingRect.Intersects(block.BoundingRect))
                {
                    ...
                    block1Corners[0] = new Vector2(block.Position.X - block.Origin.X * block.Scale, block.Position.Y - block.Origin.Y * block.Scale);
                    block1Corners[1] = new Vector2(block.Position.X + block.Origin.X * block.Scale, block.Position.Y - block.Origin.Y * block.Scale);
                    block1Corners[2] = new Vector2(block.Position.X + block.Origin.X * block.Scale, block.Position.Y + block.Origin.Y * block.Scale);
                    block1Corners[3] = new Vector2(block.Position.X - block.Origin.X * block.Scale, block.Position.Y + block.Origin.Y * block.Scale);

                    Block1CornerMarkers = new float[4];

                    for (int i = 1; i < Block1CornerMarkers.Length; i++)
                    {
                        Vector2 direction = Vector2.Normalize(block1Corners[i] - block.Position);
        ...
        public void LoadLevel()
        {
            ...
            GameObject blocks1Load = (GameObject)PhoneApplicationService.Current.State["block"];
            block.Position = blocks1Load.Position;
            ...
            for (int i = 0; i < pigRow9.Length; i++)
            {
                ...
                pigRow9[i].Velocity = row9pigs[i].Velocity;
                pigRow9[i].Scale = row9pigs[i].Scale;
            }
            ...
            for (int i = 0; i < pigRow10.Length; i++)
            {
                ...
                pigRow10[i].Velocity = row10pigs[i].Velocity;
                pigRow10[i].Scale = row10pigs[i].Scale;
            }
