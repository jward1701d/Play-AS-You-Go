...
namespace PAYG
{
    ...
    { 
        ...
        GameObject[] pigRow1 = new GameObject[16];
        GameObject[] pigRow2 = new GameObject[15];
        GameObject[] pigRow3 = new GameObject[16];
        GameObject[] pigRow4 = new GameObject[15];
        ...
        public H1N1Level_01(bool active)
        {
            TransitionOnTime = TimeSpan.FromSeconds(2);
            TransitionOffTime = TimeSpan.FromSeconds(1);
            didRestart = active;
        ...
        public override void Initialize()
        {
            ...
            // Initializes players paddel collison and give it a positon , origin, scale and speed
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                pigRow1[a] = row1Pig;
                row1Pig.Position = new Vector2(45 + row1Space, 95);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(68 + row2Space, 140);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(45 + row3Space, 185);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(68 + row4Space, 230);
            ...
            block1.Position = new Vector2(200, 315);
            ...
            block2.Position = new Vector2(600, 315);
            block2.Origin = new Vector2((block1.ActualWidth / 2) / block1.Scale, (block1.ActualHeight / 2) / block1.Scale);
            block2.Scale = .75f;
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
            ...
            if (MediaPlayer.GameHasControl && ScreenState != ScreenState.Frozen)
           {
            ...
            if (hud.Score >= highScore)
            {
                ...
                ScreenManager.RemoveAd();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, new H1N1Level_02());
            }
        ...
        private void CheckBlock2Collision()
        {
            ...
            foreach (var ball in balls)
            {
                if (ball.BoundingRect.Intersects(block2.BoundingRect))
                {
                    ...
                    Vector2[] block1Corners = new Vector2[4];
                    block1Corners[0] = new Vector2(block2.Position.X - block2.Origin.X * block2.Scale, block2.Position.Y - block2.Origin.Y * block2.Scale);
                    block1Corners[1] = new Vector2(block2.Position.X + block2.Origin.X * block2.Scale, block2.Position.Y - block2.Origin.Y * block2.Scale);
                    block1Corners[2] = new Vector2(block2.Position.X + block2.Origin.X * block2.Scale, block2.Position.Y + block2.Origin.Y * block2.Scale);
                    block1Corners[3] = new Vector2(block2.Position.X - block2.Origin.X * block2.Scale, block2.Position.Y + block2.Origin.Y * block2.Scale);

                    Block2CornerMarkers = new float[4];

                    for (int i = 1; i < Block2CornerMarkers.Length; i++)
                    {
                        Vector2 direction = Vector2.Normalize(block1Corners[i] - block2.Position);
        ...
        public void LoadLevel()
        {
            ...
            GameObject block1Load = (GameObject)PhoneApplicationService.Current.State["block1"];
            block1.Position = block1Load.Position;
            GameObject block2Load = (GameObject)PhoneApplicationService.Current.State["block2"];
            block2.Position = block2Load.Position;
