...
namespace PAYG
{
    ...
    class H1N1Level_06 : GameScreen
    {
        ...
        GameObject[] blocks2 = new GameObject[3];

        GameObject[] pigRow1 = new GameObject[1];
        GameObject[] pigRow2 = new GameObject[2];
        GameObject[] pigRow3 = new GameObject[3];
        GameObject[] pigRow4 = new GameObject[4];
        GameObject[] pigRow5 = new GameObject[5];
        GameObject[] pigRow6 = new GameObject[6];
        GameObject[] pigRow7 = new GameObject[7];
        GameObject[] pigRow8 = new GameObject[8];

        GameObject[] cellsLeft = new GameObject[5];
        GameObject[] cellsRight = new GameObject[5];

        GameObject[] extraLifes = new GameObject[2];
        ...
        public H1N1Level_06(bool active)
        {
            TransitionOnTime = TimeSpan.FromSeconds(2);
            TransitionOffTime = TimeSpan.FromSeconds(1);
            didRestart = active;
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                pigRow1[a] = row1Pig;
                row1Pig.Position = new Vector2(400, 100);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(355 + row2Space, 130);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(310 + row3Space, 160);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(265 + row4Space, 190);
            ...
            for (int e = 0; e < pigRow5.Length; e++)
            {
                ...
                pigRow5[e] = row5Pig;
                row5Pig.Position = new Vector2(220 + row5Space, 220);
            ...
            for (int f = 0; f < pigRow6.Length; f++)
            {
                ...
                pigRow6[f] = row6Pig;
                row6Pig.Position = new Vector2(175 + row6Space, 250);
            ...
            for (int f = 0; f < pigRow7.Length; f++)
            {
                ...
                pigRow7[f] = row7Pig;
                row7Pig.Position = new Vector2(130 + row7Space, 280);
            ...
            for (int f = 0; f < pigRow8.Length; f++)
            {
                ...
                pigRow8[f] = row8Pig;
                row8Pig.Position = new Vector2(85 + row8Space, 310);
            ...
            for (int x = 0; x < blocks1.Length; x++)
            {
                ...
                blocks1[x] = block1;
                block1.Position = new Vector2(125 + block1RowSpace, 160);
            ...
            for (int x = 0; x < blocks2.Length; x++)
            {
                ...
                blocks2[x] = block2;
                block2.Position = new Vector2(125 + block2RowSpace, 350);
            ...
            for (int i = 0; i < extraLifes.Length; i++)
            {
                ...
                extraLife.Position = new Vector2(250 + extralifeSpace, 100);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
           ...
           Accelerometer.GetState().Acceleration.Y, Accelerometer.GetState().Acceleration.Z);
            ...
            if (hud.Score >= highScore)
            {
                ...
                ScreenManager.RemoveAd();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, new H1N1Level_07());
        ...
        public void LoadLevel()
        {
            ...
            {
                blocks1[i].Position = blocks1Load[i].Position;
            }
            ...
            for (int i = 0; i < extraLifes.Length; i++)
            {
                extraLifes[i].Position = extraLifesLoad[i].Position;
                extraLifes[i].AnimationSpeed = TimeSpan.FromMilliseconds(600);
            }
