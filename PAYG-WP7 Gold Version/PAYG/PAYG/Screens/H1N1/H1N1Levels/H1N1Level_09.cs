...
namespace PAYG
{
    ...
    class H1N1Level_09 : GameScreen
    {
        ...
        GameObject[] pigRow1 = new GameObject[13];
        GameObject[] pigRow2 = new GameObject[12];
        ...
        GameObject[] pigRow9 = new GameObject[3];
        ...
        public H1N1Level_09(bool active)
        {
            TransitionOnTime = TimeSpan.FromSeconds(2);
            TransitionOffTime = TimeSpan.FromSeconds(1);
            didRestart = active;
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                pigRow1[a] = row1Pig;
                row1Pig.Position = new Vector2(135 + row1space, 100);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(160 + row2Space, 145);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(260 , 190 + row3Space);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(345 , 190 + row4Space);
            ...
            for (int e = 0; e < pigRow5.Length; e++)
            {
                ...
                pigRow5[e] = row5Pig;
                row5Pig.Position = new Vector2(465, 190 + row5Space);
            ...
            for (int f = 0; f < pigRow6.Length; f++)
            {
                ...
                pigRow6[f] = row6Pig;
                row6Pig.Position = new Vector2(545 , 190 + row6Space);
            ...
            for (int f = 0; f < pigRow7.Length; f++)
            {
                ...
                pigRow7[f] = row7Pig;
                row7Pig.Position = new Vector2(300  + row7Space, 210);
            ...
            for (int f = 0; f < pigRow8.Length; f++)
            {
                ...
                pigRow8[f] = row8Pig;
                row8Pig.Position = new Vector2(120 + row8Space, 275);
            ...
            for (int f = 0; f < pigRow9.Length; f++)
            {
                ...
                pigRow9[f] = row9Pig;
                row9Pig.Position = new Vector2(600 + row9Space, 275);
            ...
            for (int x = 0; x < blocks2.Length; x++)
            {
                ...
                blocks2[x] = block2;
                block2.Position = new Vector2(175 + block2RowSpace, 190);
            ...
            for (int x = 0; x < blocks3.Length; x++)
            {
                ...
                blocks3[x] = block3;
                block3.Position = new Vector2(150 + block3RowSpace, 325);
            ...
            for (int i = 0; i < extraLifes.Length; i++)
            {
                ...
                extraLife.Position = new Vector2(65 + extraLifeSpace, 110);
          ...
          Accelerometer.GetState().Acceleration.Y, Accelerometer.GetState().Acceleration.Z);
            ...
            for (int i = 0; i < balls.Length; i++)
            {
                ...
                if (hud.Score >= highScore)
                {
                    ...
                    ScreenManager.RemoveAd();
                    base.Remove();
                    LoadingScreen.Load(ScreenManager, true, new H1N1Level_10());
                }
