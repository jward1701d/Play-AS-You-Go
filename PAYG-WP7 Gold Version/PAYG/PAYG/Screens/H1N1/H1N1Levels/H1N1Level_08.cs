...
namespace PAYG
{
    ...
    class H1N1Level_08 : GameScreen
    {
        ...
        public H1N1Level_08(bool active)
        {
            TransitionOnTime = TimeSpan.FromSeconds(2);
            TransitionOffTime = TimeSpan.FromSeconds(1);
            didRestart = active;
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                pigRow1[a] = row1Pig;
                row1Pig.Position = new Vector2(60 + row1space, 110);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(650 + row2Space, 110);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(200 + row3Space, 150);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(155 + row4Space, 185);
            ...
            for (int e = 0; e < pigRow5.Length; e++)
            {
                ...
                pigRow5[e] = row5Pig;
                row5Pig.Position = new Vector2(55, 275 + row5Space);
            ...
            for (int f = 0; f < pigRow6.Length; f++)
            {
                ...
                pigRow6[f] = row6Pig;
                row6Pig.Position = new Vector2(750 , 275 + row6Space);
            ...
            for (int f = 0; f < pigRow7.Length; f++)
            {
                ...
                pigRow7[f] = row7Pig;
                row7Pig.Position = new Vector2(175  + row7Space, 275);
            ...
            for (int f = 0; f < pigRow8.Length; f++)
            {
                ...
                pigRow8[f] = row8Pig;
                row8Pig.Position = new Vector2(500  + row8Space, 275);
            ...
            for (int f = 0; f < pigRow9.Length; f++)
            {
                ...
                pigRow9[f] = row9Pig;
                row9Pig.Position = new Vector2(225 + row9Space, 350);
            ...
            for (int x = 0; x < blocks1.Length; x++)
            {
                ...
                blocks1[x] = block1;
                block1.Position = new Vector2(100 + block1RowSpace, 150);
            ...
            for (int x = 0; x < blocks2.Length; x++)
            {
                ...
                blocks2[x] = block2;
                block2.Position = new Vector2(325 + block3RowSpace, 350);
            ...
            for (int i = 0; i < extraLifes.Length; i++)
            {
                ...
                extraLife.Position = new Vector2(390, 290);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
          ...
          Accelerometer.GetState().Acceleration.Y, Accelerometer.GetState().Acceleration.Z);
            ...
            if (hud.Score >= highScore)
            {
                ...
                ScreenManager.RemoveAd();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, new H1N1Level_09());
            }
