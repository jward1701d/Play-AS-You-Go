...
namespace PAYG
{
    ...
    class H1N1Level_19 : GameScreen
    {
        ...
        GameObject[] pigRow3 = new GameObject[6];
        ...
        GameObject[] pigRow8 = new GameObject[6];
        ...
        public H1N1Level_19(bool active)
        {
            TransitionOnTime = TimeSpan.FromSeconds(2);
            TransitionOffTime = TimeSpan.FromSeconds(1);
            didRestart = active;
        ...
        public override void Initialize()
        {
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(525 + row3Space, 100);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(525 + row4Space, 145);
            ...
            for (int a = 0; a < pigRow5.Length; a++)
            {
                ...
                pigRow5[a] = row5Pig;
                row5Pig.Position = new Vector2(65 + row5Space, 255);
            ...
            for (int a = 0; a < pigRow6.Length; a++)
            {
                ...
                pigRow6[a] = row6Pig;
                row6Pig.Position = new Vector2(65 + row6Space, 300);
            ...
            for (int a = 0; a < pigRow7.Length; a++)
            {
                ...
                pigRow7[a] = row7Pig;
                row7Pig.Position = new Vector2(525 + row7Space, 255);
                row7Pig.Velocity = new Vector2(0, 2);
            ...
            for (int a = 0; a < pigRow8.Length; a++)
            {
                ...
                pigRow8[a] = row8Pig;
                row8Pig.Position = new Vector2(525 + row8Space, 300);
                row8Pig.Velocity = new Vector2(0, 2);
            ...
            block1.Position = new Vector2(75, 225);
            block1.Velocity = new Vector2(-1, 0);
            ...
            block2.Position = new Vector2(400, 150);
            block2.Velocity = new Vector2(0, -3);
            ...
            block3.Position = new Vector2(518, 225);
            block3.Velocity = new Vector2(1, 0);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
          ...
          Accelerometer.GetState().Acceleration.Y, Accelerometer.GetState().Acceleration.Z);
            ...
            foreach (var row3Pigs in pigRow3)
            {
                ...
                if (row3Pigs.Position.X >= 750)
                {
                    row3Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row3Pigs.Position.X <= 525)
                {
                    row3Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            foreach (var row4Pigs in pigRow4)
            {
                ...
                if (row4Pigs.Position.X >= 750)
                {
                    row4Pigs.Velocity = new Vector2(-2, 0f);
                }
                else if (row4Pigs.Position.X <= 525)
                {
                    row4Pigs.Velocity = new Vector2(2, 0f);
                }
            }
            ...
            foreach (var row5Pigs in pigRow5)
            {
                ...
                if (row5Pigs.Position.Y <= 255)
                {
                    row5Pigs.Velocity = new Vector2(0, 2);
                }
                else if (row5Pigs.Position.Y >= 400)
                {
                    row5Pigs.Velocity = new Vector2(0, -2);
                }
            }
            ...
            foreach (var row6Pigs in pigRow6)
            {
                ...
                if (row6Pigs.Position.Y <= 255)
                {
                    row6Pigs.Velocity = new Vector2(0, 2);
                }
                else if (row6Pigs.Position.Y >= 400)
                {
                    row6Pigs.Velocity = new Vector2(0, -2);
                }
            }
            ...
            foreach (var row7Pigs in pigRow7)
            {
                ...
                if (row7Pigs.Position.Y <= 255)
                {
                    row7Pigs.Velocity = new Vector2(0, 2);
                }
                else if (row7Pigs.Position.Y >= 400)
                {
                    row7Pigs.Velocity = new Vector2(0, -2);
                }
            }
            ...
            foreach (var row8Pigs in pigRow8)
            {
                ...
                if (row8Pigs.Position.Y <= 255)
                {
                    row8Pigs.Velocity = new Vector2(0, 2);
                }
                else if (row8Pigs.Position.Y >= 400)
                {
                    row8Pigs.Velocity = new Vector2(0, -2);
                }
            }
            ...
            if (hud.Score >= highScore)
            {
                ...
                ScreenManager.RemoveAd();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, new H1N1Level_20());               
            }
            ...
            if (block1.Position.X <= 75)
            {
                block1.Velocity = new Vector2(1, 0);
            }
            else if (block1.Position.X >= 280)
            {
                block1.Velocity = new Vector2(-1, 0);
            }
            ...
            if (block2.Position.Y <= 100)
            {
                block2.Velocity = new Vector2(0, 3);
            }
            else if (block2.Position.Y >= 325)
            {
                block2.Velocity = new Vector2(0, -3);
            }
            ...
            if (block3.Position.X <= 518)
            {
                block3.Velocity = new Vector2(1, 0);
            }
            else if (block3.Position.X >= 715)
            {
                block3.Velocity = new Vector2(-1, 0);
            }
            #endregion
