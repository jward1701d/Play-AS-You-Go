...
namespace PAYG
{
    ...
    class H1N1Level_05 : GameScreen
    {
        ...
        // Game Objects
        GameObject bars, background, paddle, paddleColision, extraLifes;
        ...
        public H1N1Level_05(bool active)
        {
            TransitionOnTime = TimeSpan.FromSeconds(2);
            TransitionOffTime = TimeSpan.FromSeconds(1);
            didRestart = active;
        ...
        public override void Initialize()
        {
            ...
            for (int a = 0; a < pigRow1.Length; a++)
            {
                ...
                pigRow1[a] = row1Pig;
                row1Pig.Position = new Vector2(60 + row1Space, 100);
            ...
            for (int b = 0; b < pigRow2.Length; b++)
            {
                ...
                pigRow2[b] = row2Pig;
                row2Pig.Position = new Vector2(95 + row2Space, 145);
            ...
            for (int c = 0; c < pigRow3.Length; c++)
            {
                ...
                pigRow3[c] = row3Pig;
                row3Pig.Position = new Vector2(465 + row3Space, 100);
            ...
            for (int d = 0; d < pigRow4.Length; d++)
            {
                ...
                pigRow4[d] = row4Pig;
                row4Pig.Position = new Vector2(435 + row4Space, 145);
            ...
            for (int e = 0; e < pigRow5.Length; e++)
            {
                ...
                pigRow5[e] = row5Pig;
                row5Pig.Position = new Vector2(200 + row5Space, 190);
            ...
            for (int f = 0; f < pigRow6.Length; f++)
            {
                ...
                pigRow6[f] = row6Pig;
                row6Pig.Position = new Vector2(175 + row6Space, 235);
            ...
            for (int f = 0; f < pigRow7.Length; f++)
            {
                ...
                pigRow7[f] = row7Pig;
                row7Pig.Position = new Vector2(575 + row7Space, 235);
            ...
            for (int f = 0; f < pigRow8.Length; f++)
            {
                ...
                pigRow8[f] = row8Pig;
                row8Pig.Position = new Vector2(200 + row8Space, 280);
            ...
            {
                GameObject block = new GameObject(SpriteSheet, new Rectangle(14, 26, 160, 32), 1, true, 0);
                blocks[x] = block;
                block.Position = new Vector2(340 + blockRowSpacing, 350);
            ...
            extraLifes.Position = new Vector2(400, 320);
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
           ...
           TouchPanel.EnabledGestures = GestureType.DoubleTap;
            ...
            if (hud.Score >= highScore)
            {
                ...
                effectBackground.Stop();
                base.Remove();
                LoadingScreen.Load(ScreenManager, true, new H1N1Level_06());
            }
        ...
        protected void SaveState(object sender, DeactivatedEventArgs args)
        {
            ...
            PhoneApplicationService.Current.State["blocks"] = blocks;
        ...
        public void LoadLevel()
        {
            ...
            GameObject[] blockssLoad = (GameObject[])PhoneApplicationService.Current.State["blocks"];
            for (int i = 0; i < blocks.Length; i++)
            {
                blocks[i].Position = blockssLoad[i].Position;
            }
