...
namespace PAYG
{
    public class BSLevel20 : GameScreen
    {
        #region Fields
        ...
        int span1 = 2;
        double toNextSpawn1 = 2;

        double span2 = 3.7;
        double toNextSpawn2 = 3.7;

        double span3 = 5.9;
        double toNextSpawn3 = 5.9;

        double span4 = 7.1;
        double toNextSpawn4 = 7.1;
        ...
        /// Constructor
        /// </summary>
        public BSLevel20(int sc, int life, bool blaster, int numMissles, int bBonus, int mBonus,
                ...
                e5 >= EnemyType5.Length)
            {
                ...
                if (!active)
                {
                    ...
                    if (defeated)
                    {
                        ...
                        if (end < 0)
                        {
                            //ScreenManager.AddScreen(new HighScoreInterface(Data, score, level, HighScore, 1));
                            if (checkFile.isSaveable)
                                LoadingScreen.Load(ScreenManager, true, new HighScoreInterface(Data, score, level, HighScore, 1));
                            else
                                LoadingScreen.Load(ScreenManager, true, new BSMainMenu());
                            backgroundMusic.Stop();
                            ScreenManager.RemoveAd();
