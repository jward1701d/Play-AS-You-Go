...
namespace PAYG
{
    public class BSLevel4 : GameScreen
    {
        #region Fields
        ...
        GameObject[] EnemyType5 = new GameObject[4];
        ...
        /// Constructor
        /// </summary>
        public BSLevel4(int sc, int life, bool blaster, int numMissles, int bBonus, int mBonus,
        ...
        public override void LoadContent()
        {
            ...
            music = content.Load<SoundEffect>("Audio/BSAudio/outer4");
                ...
                e5 >= EnemyType5.Length)
            {
                ...
                if (!active)
                {
                    ...
                    if (end < 0)
                    {
                        backgroundMusic.Stop();
                        base.Remove();
                        LoadingScreen.Load(ScreenManager, true, new BSLevel5(score, lives, doubleBlaster, numMissles, blasterBonus, missleBonus, toBlasterBonus, toMissleBonus));
                        ScreenManager.RemoveAd();
                    }
