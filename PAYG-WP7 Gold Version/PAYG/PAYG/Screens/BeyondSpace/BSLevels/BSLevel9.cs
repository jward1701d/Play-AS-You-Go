...
namespace PAYG
{
    public class BSLevel9 : GameScreen
    {
        #region Fields
        ...
        GameObject[] EnemyType5 = new GameObject[60];
        ...
        int numPaths = 2;
        List<Vector2>[] path = new List<Vector2>[2];
        ...
        int num5Count = 6;  //control variable for non-swarm enemies
        ...
        /// Constructor
        /// </summary>
        public BSLevel9(int sc, int life, bool blaster, int numMissles, int bBonus, int mBonus,
        ...
        public override void LoadContent()
        {
            ...
            music = content.Load<SoundEffect>("Audio/BSAudio/outer9");
                ...
                e5 >= EnemyType5.Length)
            {
                ...
                if (!active)
                {
                    ...
                    if (end < 0)
                    {
                        ...
                        ScreenManager.RemoveAd();
                        base.Remove();
                        LoadingScreen.Load(ScreenManager, true, new BSLevel10(score, lives, doubleBlaster, numMissles, blasterBonus, missleBonus, toBlasterBonus, toMissleBonus));
                    }
