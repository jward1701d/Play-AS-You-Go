...
namespace PAYG
{
    public class BSLevel19 : GameScreen
    {
        #region Fields
        ...
        /// Constructor
        /// </summary>
        public BSLevel19(int sc, int life, bool blaster, int numMissles, int bBonus, int mBonus,
                ...
                e5 >= EnemyType5.Length)
            {
                ...
                if (!active)
                {
                    ...
                    if (end < 0)
                    {
                        ...
                        ScreenManager.RemoveAd();
                        base.Remove();
                        LoadingScreen.Load(ScreenManager, true, new BSLevel20(score, lives, doubleBlaster, numMissles, blasterBonus, missleBonus, toBlasterBonus, toMissleBonus));
