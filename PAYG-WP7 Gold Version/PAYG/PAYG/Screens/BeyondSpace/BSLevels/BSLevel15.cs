...
namespace PAYG
{
    public class BSLevel15 : GameScreen
    {
        #region Fields
        ...
        GameObject[] EnemyType2 = new GameObject[9];
        GameObject[] EnemyType3 = new GameObject[7];
        GameObject[] EnemyType4 = new GameObject[7];
        GameObject[] EnemyType5 = new GameObject[59];
        GameObject[] enemyBullets = new GameObject[20];
        ...
        /// Constructor
        /// </summary>
        public BSLevel15(int sc, int life, bool blaster, int numMissles, int bBonus, int mBonus,
                ...
                if (!active)
                {
                    ...
                    if (defeated)
                    {
                        ...
                        if (end < 0)
                        {
                            ...
                            ScreenManager.RemoveAd();
                            base.Remove();
                            LoadingScreen.Load(ScreenManager, true, new BSLevel16(score, lives, doubleBlaster, numMissles, blasterBonus, missleBonus, toBlasterBonus, toMissleBonus));
