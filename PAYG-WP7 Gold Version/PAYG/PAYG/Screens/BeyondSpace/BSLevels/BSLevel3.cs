...
namespace PAYG
{
    public class BSLevel3 : GameScreen
    {
        #region Fields
        ...
        /// Constructor
        /// </summary>
        public BSLevel3(int sc, int life, bool blaster, int numMissles, int bBonus, int mBonus,
        ...
        public override void LoadContent()
        {
            ...
            music = content.Load<SoundEffect>("Audio/BSAudio/outer3");
                ...
                e5 >= EnemyType5.Length)
            {
                ...
                if (!active)
                {
                    ...
                    if (end < 0)
                    {
                        ...
                        ScreenManager.RemoveAd();
                        base.Remove();
                        LoadingScreen.Load(ScreenManager, true, new BSLevel4(score, lives, doubleBlaster, numMissles, blasterBonus, missleBonus, toBlasterBonus, toMissleBonus));
                    }
