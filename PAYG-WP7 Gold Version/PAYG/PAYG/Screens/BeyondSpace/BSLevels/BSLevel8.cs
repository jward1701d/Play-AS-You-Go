...
namespace PAYG
{
    public class BSLevel8 : GameScreen
    {
        #region Fields
        ...
        GameObject[] EnemyType5 = new GameObject[48];
        ...
        /// Constructor
        /// </summary>
        public BSLevel8(int sc, int life, bool blaster, int numMissles, int bBonus, int mBonus,
                ...
                e5 >= EnemyType5.Length)
            {
                ...
                if (!active)
                {
                    ...
                    if (end < 0)
                    {
                        ...
                        ScreenManager.RemoveAd();
                        base.Remove();
                        LoadingScreen.Load(ScreenManager, true, new BSLevel9(score, lives, doubleBlaster, numMissles, blasterBonus, missleBonus, toBlasterBonus, toMissleBonus));
                    }
