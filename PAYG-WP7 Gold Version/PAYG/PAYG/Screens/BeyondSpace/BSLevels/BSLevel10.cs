...
namespace PAYG
{
    public class BSLevel10 : GameScreen
    {
        #region Fields
        ...
        GameObject[] EnemyType1 = new GameObject[12];
        GameObject[] EnemyType2 = new GameObject[10];
        GameObject[] EnemyType3 = new GameObject[8];
        GameObject[] EnemyType4 = new GameObject[8];
        GameObject[] EnemyType5 = new GameObject[50];
        ...
        int numPaths = 10;
        List<Vector2>[] path = new List<Vector2>[10];
        ...
        int span1 = 3;
        double toNextSpawn1 = 1;

        double span2 = 4.2;
        double toNextSpawn2 = 5;

        double span3 = 6.4;
        double toNextSpawn3 = 5;

        double span4 = 6.6;
        double toNextSpawn4 = 5;

        int span5 = 6;
        int num5Spawns;  //needed to ensure the swarm is accounted for
        int num5Count = 0;  //control variable for non-swarm enemies
        double toNextSpawn5 = 6;

        int spanSwarm = 20;
        double toNextSwarm = 20;
        int swarmCount = 2; //control variable for swarm enemies
        int swarmTimes = 0;
        ...
        /// Constructor
        /// </summary>
        public BSLevel10(int sc, int life, bool blaster, int numMissles, int bBonus, int mBonus,
                ...
                if (!active)
                {
                    ...
                    if (defeated)
                    {
                        ...
                        if (end < 0)
                        {
                            ...
                            ScreenManager.RemoveAd();
                            base.Remove();
                            LoadingScreen.Load(ScreenManager, true, new BSLevel11(score, lives, doubleBlaster, numMissles, blasterBonus, missleBonus, toBlasterBonus, toMissleBonus));
                        }
                    }
                }//end if
            }//end if
