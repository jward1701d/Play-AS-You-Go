...
namespace PAYG
{
    public class BSLevel6 : GameScreen
    {
        #region Fields
        ...
        GameObject[] EnemyType5 = new GameObject[21];
        ...
        int numPaths = 1;
        List<Vector2>[] path = new List<Vector2>[1];
        ...
        /// Constructor
        /// </summary>
        public BSLevel6(int sc, int life, bool blaster, int numMissles, int bBonus, int mBonus,
        ...
        public override void LoadContent()
        {
            ...
            music = content.Load<SoundEffect>("Audio/BSAudio/outer6");
                ...
                e5 >= EnemyType5.Length)
            {
                ...
                if (!active)
                {
                    ...
                    if (end < 0)
                    {
                        ...
                        ScreenManager.RemoveAd();
                        base.Remove();
                        LoadingScreen.Load(ScreenManager, true, new BSLevel7(score, lives, doubleBlaster, numMissles, blasterBonus, missleBonus, toBlasterBonus, toMissleBonus));
                    }
