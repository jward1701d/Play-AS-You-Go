...
namespace PAYG
{
    public class BSLevel16 : GameScreen
    {
        #region Fields
        ...
        GameObject[] EnemyType5 = new GameObject[70];
        ...
        /// Constructor
        /// </summary>
        public BSLevel16(int sc, int life, bool blaster, int numMissles, int bBonus, int mBonus,
                ...
                e5 >= EnemyType5.Length)
            {
                ...
                if (!active)
                {
                    ...
                    if (end < 0)
                    {
                        ...
                        ScreenManager.RemoveAd();
                        base.Remove();
                        LoadingScreen.Load(ScreenManager, true, new BSLevel17(score, lives, doubleBlaster, numMissles, blasterBonus, missleBonus, toBlasterBonus, toMissleBonus));
