...
namespace PAYG
{
    public class BSLevel7 : GameScreen
    {
        #region Fields
        ...
        GameObject[] EnemyType1 = new GameObject[16];
        GameObject[] EnemyType2 = new GameObject[14];
        GameObject[] EnemyType3 = new GameObject[9];
        GameObject[] EnemyType4 = new GameObject[9];
        GameObject[] EnemyType5 = new GameObject[42];
        ...
        /// Constructor
        /// </summary>
        public BSLevel7(int sc, int life, bool blaster, int numMissles, int bBonus, int mBonus,
                ...
                e5 >= EnemyType5.Length)
            {
                ...
                if (!active)
                {
                    ...
                    if (end < 0)
                    {
                        ...
                        base.Remove();
                        ScreenManager.RemoveAd();
                        LoadingScreen.Load(ScreenManager, true, new BSLevel8(score, lives, doubleBlaster, numMissles, blasterBonus, missleBonus, toBlasterBonus, toMissleBonus));
                    }
